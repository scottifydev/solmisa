...
async function renderKeySigStaff(
  ...
  function addAccidental(
    ...
    text.setAttribute(
      "style",
      `user-select:none; pointer-events:none; filter:drop-shadow(0 0 3px ${color === "#4ade80" ? "rgba(74,222,128,0.4)" : color === "#f87171" ? "rgba(248,113,113,0.4)" : "rgba(139,92,246,0.4)"})`,
    );
