...
// ── Note pools per clef ─────────────────────────────────────────────────────
const TREBLE_NOTES = [
  { name: "C", vexKey: "c/4", tone: "C4" },
  { name: "D", vexKey: "d/4", tone: "D4" },
  { name: "E", vexKey: "e/4", tone: "E4" },
  { name: "F", vexKey: "f/4", tone: "F4" },
  { name: "G", vexKey: "g/4", tone: "G4" },
  { name: "A", vexKey: "a/4", tone: "A4" },
  { name: "B", vexKey: "b/4", tone: "B4" },
  { name: "C", vexKey: "c/5", tone: "C5" },
  { name: "D", vexKey: "d/5", tone: "D5" },
  { name: "E", vexKey: "e/5", tone: "E5" },
  { name: "F", vexKey: "f/5", tone: "F5" },
];

const BASS_NOTES = [
  { name: "E", vexKey: "e/2", tone: "E2" },
  { name: "F", vexKey: "f/2", tone: "F2" },
  { name: "G", vexKey: "g/2", tone: "G2" },
  { name: "A", vexKey: "a/2", tone: "A2" },
  { name: "B", vexKey: "b/2", tone: "B2" },
  { name: "C", vexKey: "c/3", tone: "C3" },
  { name: "D", vexKey: "d/3", tone: "D3" },
  { name: "E", vexKey: "e/3", tone: "E3" },
  { name: "F", vexKey: "f/3", tone: "F3" },
  { name: "G", vexKey: "g/3", tone: "G3" },
  { name: "A", vexKey: "a/3", tone: "A3" },
];
